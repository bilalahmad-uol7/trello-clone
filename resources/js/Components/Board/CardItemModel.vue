...
function closeModal() {
  router.get(route('board'), {}, {
    preserveState: true
  });
}

function onSubmit() {
  form.put(route('board.card.update', {card: props.card.id}));
}
</script>
              ...
              <div class="flex flex-col sm:flex-row">
                ...
                >
                  ...
                  <div class="mt-2 space-x-2">
                    <button
                      class="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md shadow-sm hover:bg-green-500 focus:ring-2 focus:ring-offset-2 focus:ring-green-500 focus:outline-none"
                      type="submit"
                    >Save card
                    </button>
                    <button
                ...
                <div class="p-5 bg-gray-100 sm:w-48">
                  ...
                  <Link
                    ...
                    method="delete"
                    as="button"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-red-200 rounded-md shadow-sm hover:bg-red-300 focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 focus:outline-none"
                  >
